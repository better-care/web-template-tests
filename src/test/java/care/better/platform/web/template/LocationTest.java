...
public class LocationTest extends AbstractWebTemplateTest {
    ...
    public void location() throws Exception {
        ...
        assertThat(rawComposition.get("content").get(0).get("items").get(0).get("data").get("origin")
                           .get("value").asText().compareTo(dateTime.toString())).isEqualTo(0);
        JsonNode observationNode = rawComposition.get("content").get(0).get("items").get(0);
        assertThat(observationNode.get("data").get("origin").get("value").asText().compareTo(dateTime.toString())).isEqualTo(0);
        assertThat(rawComposition.get("context").get("end_time").get("value").asText()).isEqualTo("2016-01-01T12:30:30Z");
        assertThat(rawComposition.get("context").get("location").asText()).isEqualTo("1234 Best Exotic Marigold Hotel");
    }
}
